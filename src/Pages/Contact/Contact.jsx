...
// Placeholder for a component you might have in your project
const Title = ({ title, des }) => (
  <div className="text-center mb-12">
    <h2 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl">
      {title}
    </h2>
    <p className="mt-4 text-lg text-gray-400">{des}</p>
  </div>
);
      ...
      <div className="relative z-10 px-4 my-6 md:my-12">
        ...
        <div className="relative z-10 mx-auto max-w-[1440px] rounded-3xl border border-white/10 bg-white/5 p-6 shadow-2xl backdrop-blur-md md:p-12 lg:p-16">
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            <div>
              <h3 className="mb-6 text-3xl font-bold tracking-tight text-white">Get in Touch</h3>
            ...
            <div>
              <h3 className="mb-6 text-3xl font-bold tracking-tight text-white">Leave a Message</h3>
              <Form />
            </div>
          </div>
        </div>
